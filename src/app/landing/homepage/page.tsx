...
export default function HomePage() {
  ...
  return (
    // Added pt-[80px] to push content down past the fixed header
  // Also changed justify-center to the more standard max-w and mx-auto 
  <main className="bg-white overflow-x-hidden pt-[80px] mx-auto">
      {/* Hero Section */}
