...
<p className="relative top-[200px] left-[100px] text-center text-black text-[32px] font-bold max-w-[668px] mx-auto mb-12 justify-items-center-safe">
  ...
  <p className="relative top-[80px] left-[750px] text-center text-[32px] font-medium text-[#36683d] max-w-[600px] mx-auto mb-8">
  ...
  {' '}?
        ...
        <p className="text-3xl font-medium text-[#ffec84] mb-10">
        ...
        <p className="text-3xl h-20 font-medium text-[#ffec84]">
...
<section className="py-10 mt-48 w-full overflow-x-hidden">
  <div className="max-w-[1920px] mx-auto px-0">
  <div
    className="relative w-fit mb-20"
    style={{
      backgroundImage: "url('/hiwbg.svg')",
      backgroundSize: "100% 100%",
      backgroundPosition: "center",
      backgroundRepeat: "no-repeat",
      width: "1500px", // 1.5x original width
      height: "299.53px", // 1.5x original height
      display: "flex",
      alignItems: "center",
  ...
  >
    <div className="w-full flex justify-center items-center h-full">
      <h2
        className="text-[80px] font-extrabold text-center"
        style={{
...
<div className="absolute top-[-75px] px-199 left-1/2 -translate-x-1/2 w-full max-w-[1405px]">
              ...
              {faqs.map((faq, i) => {
                ...
                <article
                  ...
                  className={`rounded-lg p-5 transition-all ${
                    isOpen ? "bg-white shadow-lg" : "bg-[#f7f7f7]"
                  }`}
                >
                  <button
